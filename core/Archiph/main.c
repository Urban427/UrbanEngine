...
"C:\Program Files (x86)\Steam\steamapps\common\Blender\blender"  "C:/Dop/Models/box.blend" --python-expr "import bpy; bpy.ops.export_scene.fbx(filepath='C:/Dop/build/GlassWars/Assets/box.fbx')" -b

#include "archiver.h"
#include <zlib.h>

constexpr uint32_t hash4ByteString(const char* str) {
